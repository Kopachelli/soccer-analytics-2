...
url_set = {"Barnsley":"https://en.wikipedia.org/wiki/List_of_Birmingham_City_F.C._managers",
			"Bolton":"https://en.wikipedia.org/wiki/List_of_Bolton_Wanderers_F.C._managers",
			"BradfordCity":"https://en.wikipedia.org/wiki/List_of_Bradford_City_A.F.C._managers",
			"CardiffCity":"https://en.wikipedia.org/wiki/List_of_Cardiff_City_F.C._managers",
			"CoventryCity":"https://en.wikipedia.org/wiki/List_of_Coventry_City_F.C._managers",
			"DerbyCounty":"https://en.wikipedia.org/wiki/List_of_Derby_County_F.C._managers",
			"HullCity":"https://en.wikipedia.org/wiki/List_of_Hull_City_A.F.C._managers",
			"IpswichTown":"https://en.wikipedia.org/wiki/List_of_Ipswich_Town_F.C._managers",
			"LeedsUnited":"https://en.wikipedia.org/wiki/List_of_Leeds_United_F.C._managers",
			"Middlesbrough":"https://en.wikipedia.org/wiki/List_of_Middlesbrough_F.C._managers",
			"OldhamAthletic":"https://en.wikipedia.org/wiki/List_of_Oldham_Athletic_A.F.C._managers",
			"QPR":"https://en.wikipedia.org/wiki/List_of_Queens_Park_Rangers_F.C._managers",
			"Reading":"https://en.wikipedia.org/wiki/List_of_Reading_F.C._managers",
			"SheffieldUnited":"https://en.wikipedia.org/wiki/List_of_Sheffield_United_F.C._managers",
			"SheffieldWednesday":"https://en.wikipedia.org/wiki/List_of_Sheffield_Wednesday_F.C._managers",
			"Wolverhampton":"https://en.wikipedia.org/wiki/List_of_Wolverhampton_Wanderers_F.C._managers"}

# {"Arsenal":"https://en.wikipedia.org/wiki/List_of_Arsenal_F.C._managers",
